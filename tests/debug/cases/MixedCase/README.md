# Debug Golden Output Files for MixedCase
...
This directory contains debug information generated from `tests/cases/views/MixedCase/view.json`:
...
```bash
python scripts/generate_debug_files.py MixedCase
```
