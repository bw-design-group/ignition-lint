# Debug Golden Output Files for BadContextData
...
This directory contains debug information generated from `tests/cases/views/BadContextData/view.json`:
...
```bash
python scripts/generate_debug_files.py BadContextData
```
