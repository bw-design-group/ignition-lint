# Debug Golden Output Files for UPPER_CASE
...
This directory contains debug information generated from `tests/cases/views/UPPER_CASE/view.json`:
...
```bash
python scripts/generate_debug_files.py UPPER_CASE
```
