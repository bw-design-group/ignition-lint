# Debug Golden Output Files for PylintViolations
...
This directory contains debug information generated from `tests/cases/views/PylintViolations/view.json`:
...
```bash
python scripts/generate_debug_files.py PylintViolations
```
