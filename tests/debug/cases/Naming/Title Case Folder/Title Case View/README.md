# Debug Golden Output Files for Naming/Title Case Folder/Title Case View
...
This directory contains debug information generated from `tests/cases/views/Naming/Title Case Folder/Title Case View/view.json`:
