# Debug Golden Output Files for Naming/PascalFolder/PascalView
...
This directory contains debug information generated from `tests/cases/views/Naming/PascalFolder/PascalView/view.json`:
...
```bash
python scripts/generate_debug_files.py Naming/PascalFolder/PascalView
```
