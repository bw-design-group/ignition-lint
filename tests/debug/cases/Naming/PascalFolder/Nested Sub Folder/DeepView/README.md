# Debug Golden Output Files for Naming/PascalFolder/Nested Sub Folder/DeepView
...
This directory contains debug information generated from `tests/cases/views/Naming/PascalFolder/Nested Sub Folder/DeepView/view.json`:
...
```bash
python scripts/generate_debug_files.py Naming/PascalFolder/Nested Sub Folder/DeepView
```
