# Debug Golden Output Files for snake_case
...
This directory contains debug information generated from `tests/cases/views/snake_case/view.json`:
...
```bash
python scripts/generate_debug_files.py snake_case
```
