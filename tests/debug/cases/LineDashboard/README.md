# Debug Golden Output Files for LineDashboard
...
This directory contains debug information generated from `tests/cases/views/LineDashboard/view.json`:
...
```bash
python scripts/generate_debug_files.py LineDashboard
```
