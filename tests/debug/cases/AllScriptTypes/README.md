# Debug Golden Output Files for AllScriptTypes
...
This directory contains debug information generated from `tests/cases/views/AllScriptTypes/view.json`:
...
```bash
python scripts/generate_debug_files.py AllScriptTypes
```
