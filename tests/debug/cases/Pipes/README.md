# Debug Golden Output Files for Pipes
...
This directory contains debug information generated from `tests/cases/views/Pipes/view.json`:
...
```bash
python scripts/generate_debug_files.py Pipes
```
