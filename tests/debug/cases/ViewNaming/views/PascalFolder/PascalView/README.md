# Debug Golden Output Files for ViewNaming/views/PascalFolder/PascalView
...
This directory contains debug information generated from `tests/cases/ViewNaming/views/PascalFolder/PascalView/view.json`:
...
```bash
python scripts/generate_debug_files.py ViewNaming/views/PascalFolder/PascalView
```
