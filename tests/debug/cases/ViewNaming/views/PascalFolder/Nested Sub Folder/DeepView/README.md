# Debug Golden Output Files for ViewNaming/views/PascalFolder/Nested Sub Folder/DeepView
...
This directory contains debug information generated from `tests/cases/ViewNaming/views/PascalFolder/Nested Sub Folder/DeepView/view.json`:
...
```bash
python scripts/generate_debug_files.py ViewNaming/views/PascalFolder/Nested Sub Folder/DeepView
```
