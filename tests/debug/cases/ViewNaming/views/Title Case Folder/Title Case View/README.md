# Debug Golden Output Files for ViewNaming/views/Title Case Folder/Title Case View
...
This directory contains debug information generated from `tests/cases/ViewNaming/views/Title Case Folder/Title Case View/view.json`:
