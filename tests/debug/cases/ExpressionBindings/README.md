# Debug Golden Output Files for ExpressionBindings
...
This directory contains debug information generated from `tests/cases/views/ExpressionBindings/view.json`:
...
```bash
python scripts/generate_debug_files.py ExpressionBindings
```
