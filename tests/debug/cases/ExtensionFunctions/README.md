# Debug Golden Output Files for ExtensionFunctions
...
This directory contains debug information generated from `tests/cases/views/ExtensionFunctions/view.json`:
...
```bash
python scripts/generate_debug_files.py ExtensionFunctions
```
