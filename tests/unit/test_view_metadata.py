...
NESTED_VIEW = CASES_DIR / 'ViewNaming' / 'views' / 'Title Case Folder' / 'Title Case View' / 'view.json'
...
class TestBuilderViewCollection(unittest.TestCase):
	...
	def test_view_node_built_from_source_path(self):
		...
		self.assertEqual(view.folder_path, ['Title Case Folder'])
...
class TestEngineViewPlumbing(unittest.TestCase):
	...
	def test_rule_receives_view_node(self):
		...
		self.assertEqual(rule.visited[0].view_path, 'Title Case Folder/Title Case View')
	...
	def test_statistics_and_debug_include_view(self):
		...
		self.assertEqual(debug[0]['view_path'], 'Title Case Folder/Title Case View')
	...
	def test_rule_impact_summary_for_view(self):
		...
		self.assertEqual(details[0]['summary'], "View 'Title Case View' in folder 'Title Case Folder'")
