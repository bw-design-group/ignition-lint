...
- **Verify before committing**: Ensure code quality and that tests pass before committing
...
- **Simple Descriptions**: Add direct and straightforward descriptions only when the additional context is warranted
...
- Third commit: build: update package dependencies
- Fourth commit: feat: add type definitions for new API endpoints
- Fifth commit: feat: improve concurrency handling in worker threads
- Sixth commit: fix: resolve linting issues in new code
- Seventh commit: test: add unit tests for new version features
...
- NEVER reference co-author attribution to Claude or Claude Code in the commit message
