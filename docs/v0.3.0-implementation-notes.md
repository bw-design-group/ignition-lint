    ...
    steps:
      ...
      - name: Test CLI functionality
        run: |
          ...
          poetry run python -m ignition_lint --config .github/workflows/.ign-lint-ci.json --files tests/cases/PascalCase/view.json --ignore-warnings
...
- ✅ Package published on PyPI at https://pypi.org/project/ign-lint/
- ✅ Version on PyPI matches git tag and pyproject.toml
- ✅ `pip install ign-lint` installs successfully
- ✅ CLI command `ign-lint` is available after installation
